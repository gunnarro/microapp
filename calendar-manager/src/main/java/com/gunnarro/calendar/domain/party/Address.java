...
public class Address extends BaseDomain {
    ...
    public String toString() {
        return "Address [isAddressValid=" + this.isAddressValid() + ", id=" + getId() + ", streetName=" + streetName + ", streetNumber=" + streetNumber
                + ", streetNumberPostfix=" + streetNumberPostfix + ", postalCode=" + postCode + ", city=" + city + ", country=" + country + "]";
    }
