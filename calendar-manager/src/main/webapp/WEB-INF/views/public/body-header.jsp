	...
	<nav role="navigation" class="navbar navbar-default">
		...
		<div class="navbar-header">
			<button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#navbarCollapse">
			 ...
			 <a href="/diet-manager/diet/mystatus">
		...
		<div id="navbarCollapse" class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li><a href="diet-manager/diet/mystatus"><i class="icon-happy2"></i> <spring:message code="topmenu.status"/></a></li>
				<li><a href="diet-manager/diet/dietplan/current"><i class="glyphicon glyphicon-list"></i> <spring:message code="topmenu.dietplan"/></a></li>
				<li><a href="diet-manager/diet/menu/current"><i class="glyphicon glyphicon-list"></i> <spring:message code="topmenu.menu"/></a></li>
				<li><a href="diet-manager/diet/recipes"><i class="glyphicon glyphicon-list"></i> <spring:message code="topmenu.recipes"/></a></li>
				<li><a href="diet-manager/diet/changelist"><i class="glyphicon glyphicon-list"></i> <spring:message code="topmenu.changelist"/></a></li>
				<li><a href="diet-manager/diet/mychoices"><i class="glyphicon glyphicon-check"></i> <spring:message code="topmenu.mychoices"/></a></li>
				<li><a href="diet-manager/diet/body/measurement/log"><i class="glyphicon glyphicon-stats"></i> <spring:message code="topmenu.measurements"/></a></li>
