...
VALUES 
(1,now(),now(),1,'Jenter 13 år 9-er 2.div avd 03', 'sagene', 'http://www.fotball.no/templates/portal/pages/GenerateICalendar.aspx?tournamentid=144524','icalendar','calendar events for j13 9-er football 2015', 0),
(2,now(),now(),1,'Gutter 12 år avd 13', 'lyn', 'http://www.fotball.no/templates/portal/pages/GenerateICalendar.aspx?teamId=8679','icalendar','calendar events for g12 football', 0),
