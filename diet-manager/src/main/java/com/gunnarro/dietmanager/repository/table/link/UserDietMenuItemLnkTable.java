...
public class UserDietMenuItemLnkTable {
    ...
    public static final String COLUMN_FK_CONTROLLED_BY__USER_ID = "fk_controlled_by_user_id";
    public static final String COLUMN_FK_DIET_MENU_ITEM_ID = "fk_diet_menu_item_id";
    public static final String COLUMN_FK_PREPARED_BY__USER_ID = "fk_prepared_by_user_id";
    ...
    private static final String[] INSERT_TABLE_COLUMNS = new String[] { TableHelper.COLUMN_CREATED_DATETIME, COLUMN_FK_USER_ID, COLUMN_FK_DIET_MENU_ITEM_ID,
            COLUMN_FK_CONTROLLED_BY__USER_ID, COLUMN_FK_PREPARED_BY__USER_ID, COLUMN_CAUSED_CONFLICT, COLUMN_FK_LOG_ID };

    private static final String[] TABLE_FK_COLUMNS = { COLUMN_FK_USER_ID, COLUMN_FK_DIET_MENU_ITEM_ID, COLUMN_FK_CONTROLLED_BY__USER_ID, COLUMN_FK_PREPARED_BY__USER_ID,
            COLUMN_CAUSED_CONFLICT, COLUMN_FK_LOG_ID };
