...
public class UserDietMenuItemLnkTable {
    ...
    private static final String[] TABLE_FK_COLUMNS = { COLUMN_FK_USER_ID, COLUMN_FK_DIET_MENU_ITEM_ID, COLUMN_FK_CONTROLLED_BY__USER_ID,
            COLUMN_FK_PREPARED_BY__USER_ID, COLUMN_CAUSED_CONFLICT, COLUMN_FK_LOG_ID };
