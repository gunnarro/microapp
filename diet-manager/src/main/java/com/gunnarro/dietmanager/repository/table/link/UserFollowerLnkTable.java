...
public class UserFollowerLnkTable {

    // Database table
    public static final String TABLE_NAME = "user_follower_lnk";
     ...
     */
    private UserFollowerLnkTable() {
    }

    public static PreparedStatementCreator createInsertPreparedStatement(final Integer userId, final Integer userFollowerId) {
