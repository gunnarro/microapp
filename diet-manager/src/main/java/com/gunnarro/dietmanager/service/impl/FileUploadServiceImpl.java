...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    public FileUploadServiceImpl() {
        this.rootLocation = Paths.get("src/main/resources/uploadedfiles");
    }
    ...
    public void store(MultipartFile file, String id, String description) {
        try {
            ...
            if (file.getOriginalFilename().contains("..")) {
                ...
                throw new UploadFileException("Cannot store file with relative path outside current directory " + file.getOriginalFilename());
            }
