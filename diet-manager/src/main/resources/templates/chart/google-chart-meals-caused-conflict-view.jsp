 ...
 <script type="text/javascript" charset="utf-8">
  ...
  function drawLineChart() {
	  var options = {
      	title: 'Antall Måltider Som Har Forårsaket Konflikter',
      	curveType: 'function',
      	legend: { position: 'bottom' },
    };
    var jsonResponse = loadDataSynchronous("/diet-manager/rest/chart/data/causedconflict");
	...
	var chart = new google.visualization.LineChart(document.getElementById('linechart_causedconflict'));
    chart.draw(dataTable, options);
  }
  </script>
 
  <div id="linechart_causedconflict" class="chart"></div>
