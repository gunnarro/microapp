 ...
 <script type="text/javascript" charset="utf-8">
  ...
  function drawLineChart() {
	  var options = {
      	title: 'Antall Måltider Kontrollert av',
      	curveType: 'function',
      	legend: { position: 'bottom' },
    };
    var jsonResponse = loadDataSynchronous("/diet-manager/rest/chart/data/controlledby");
	...
	var chart = new google.visualization.LineChart(document.getElementById('linechart_controlledby'));
    chart.draw(dataTable, options);
  }
  </script>
 
  <div id="linechart_controlledby" class="chart"></div>
