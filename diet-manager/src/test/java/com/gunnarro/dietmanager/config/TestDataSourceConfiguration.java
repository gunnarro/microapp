...
//	        if (jdbcPwd == null){
//	        	throw new RuntimeException("jdbc pwd not set! pwd: " + jdbcPwd + ", encoded: " + pwdEncoder.decrypt(jdbcPwd));
//	        }
...
//    @Primary
    ...
    public DataSourceTransactionManager transactionManager() {
        final DataSourceTransactionManager transactionManager = new DataSourceTransactionManager(logEventDataSource());
