...
@ContextConfiguration(classes = { TestDataSourceConfiguration.class, DietManagerServiceImpl.class,
		DietManagerRepositoryImpl.class, LogEventRepositoryImpl.class })
@Transactional
@Rollback
public class DietManagerServiceTest extends DefaultTestConfig {
	...
	public void getMealStatistic() {
		...
		Map<Key, List<MealStatistic>> mealStatisticByWeekNumberMap = DietManagerServiceImpl
				.mapMealStatisticByWeekNumber(mealStatsticList);
		...
		List<MealStatistic> sumMealStatisticByUserName = DietManagerServiceImpl
				.sumMealStatisticByUserName(mealStatsticList);
