...
public class UtilityTest {
    ...
    public void convertMarkdown() {
    	String txt = 
    			"**Brev  fra Emilie 19.06.2017**"

    			+ "Hva vi kan gjøre for å unngå:"
    			+ "1. Stress for deg på ferie med mamma"
    			+ "2. Unngå vekttap"
    			+ "3. Unngå bekymringer vedrørende sniktrening"
...
//        System.out.println("Days Old: " + getTimeDiff(new Date(), birthDateCal.getTime()));
//        System.out.println("Years Old: " + (Calendar.getInstance().get(Calendar.YEAR) - birthDateCal.get(Calendar.YEAR)));
//        System.out.println("Years + mounths Old: " + Calendar.getInstance().get(Calendar.MONTH) + " - " + birthDateCal.get(Calendar.MONTH));
//        System.out.println("Days: " + Days.daysBetween(new DateTime(), birthDate));
    }
...
//        System.out.println(Utility.formatTime(System.currentTimeMillis(), "ww, dd.MM.yyyy"));
