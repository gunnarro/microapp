...
public class ContactVolunteerSubTaskLnkTable {
    ...
    // Database table
    public static final String TABLE_NAME = "contact_volunteer_sub_task_lnk";
    private static final String COLUMN_FK_CONTACT_ID = "fk_contact_id";

    private static final String COLUMN_FK_VOLUNTEER_SUB_TASK_ID = "fk_sub_task_id";
    
    private static final String[] TABLE_FK_COLUMNS = { COLUMN_FK_CONTACT_ID, COLUMN_FK_VOLUNTEER_SUB_TASK_ID };
    
    private ContactVolunteerSubTaskLnkTable() {
    }
