		...
		<thead>
			<tr class="info">
				<th colspan="5" class="text-left">
					<form:form modelAttribute="searchActivity" method="GET" action="/calendar/search/events" id="calendar-search-form-id"> 
					...
					<tr id="row_${event.id}">
						...
						<c:choose>
							<c:when test="${event.type == 'match'}">
								<td class="text-left" style="border-top: none;"><small><a class="${txtColor}" href="https://www.fotball.no/fotballdata/kamp/?fiksId=${event.id}">${event.summary}</a></small></td>
