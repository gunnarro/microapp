...
<body style="background: #eee !important;">
	...
	<div class="container">
      <form class="form-signin" name="form" action="/login.do" method="POST">
        <sec:csrfInput />
        <img class="profile-img" src="/resources/images/signin.jpg?sz=120" alt="SporTzTeam - LogIn">
		...
		<c:if test="not empty ${request.getParameter('cause')}">
			<div class="alert alert-info" role="alert">
				You have been redirected to login page because:
        ...
        <div class="row">
		  ...
		  <div class="col-xs-6 col-md-4">
			<small><font style="color:green">SporT</font><font style="color:red">z</font><font style="color:blue">Team</font></small>
		  </div>
		</div>
      </form>
    </div> <!-- /container -->
