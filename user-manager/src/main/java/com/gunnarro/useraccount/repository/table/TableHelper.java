package com.gunnarro.useraccount.repository.table;
...
public class TableHelper {
    ...
    public static String[] createColumns(String[] columns) {
        ...
        columnNames.add(ColumnsDefaultEnum.id.name());
        columnNames.add(ColumnsDefaultEnum.created_date_time.name());
        columnNames.add(ColumnsDefaultEnum.last_modified_date_time.name());
    ...
    public static String createUpdateQuery(String tableName, String[] columnNames) {
        return createUpdateQuery(ColumnsDefaultEnum.id.name(), tableName, columnNames);
    }
    ...
    public static String defaultContentValues() {
        StringBuilder query = new StringBuilder();
        query.append(ColumnsDefaultEnum.last_modified_date_time.name());
        return query.toString();
    }
